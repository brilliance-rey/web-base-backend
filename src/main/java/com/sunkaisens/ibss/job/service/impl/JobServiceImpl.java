package com.sunkaisens.ibss.job.service.impl;
...
import com.sunkaisens.ibss.job.dao.JobMapper;
import com.sunkaisens.ibss.job.domain.Job;
import com.sunkaisens.ibss.job.service.JobService;
import com.sunkaisens.ibss.job.util.ScheduleUtils;
...
public class JobServiceImpl extends ServiceImpl<JobMapper, Job> implements JobService {
    ...
    public IPage<Job> findJobs(QueryRequest request, Job job) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "createTime", IBSSConstant.ORDER_DESC, true);
