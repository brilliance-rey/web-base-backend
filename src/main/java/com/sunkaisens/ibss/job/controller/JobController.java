...
import com.sunkaisens.ibss.job.domain.Job;
import com.sunkaisens.ibss.job.service.JobService;
...
public class JobController extends BaseController {
    ...
    public void addJob(@Valid Job job) throws SysInnerException {
        try {
    ...
    public void deleteJob(@NotBlank(message = "{required}") @PathVariable String jobIds) throws SysInnerException {
        try {
    ...
    public void updateJob(@Valid Job job) throws SysInnerException {
        try {
    ...
    public void runJob(@NotBlank(message = "{required}") @PathVariable String jobId) throws SysInnerException {
        try {
    ...
    public void pauseJob(@NotBlank(message = "{required}") @PathVariable String jobId) throws SysInnerException {
        try {
    ...
    public void resumeJob(@NotBlank(message = "{required}") @PathVariable String jobId) throws SysInnerException {
        try {
    ...
    public void export(QueryRequest request, Job job, HttpServletResponse response) throws SysInnerException {
        try {
